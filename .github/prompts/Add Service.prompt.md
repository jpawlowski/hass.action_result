...
Create `custom_components/ha_integration_domain/services/[service_name].py`:

```python
"""[Service name] service for Integration Blueprint."""
...
3. Find service: `ha_integration_domain.[service_name]`
...
- **Services directory:** `custom_components/ha_integration_domain/services/`
- **Services definition:** `custom_components/ha_integration_domain/services.yaml`
